$(document).ready(function() {
	...
	$("#registerButton").click(function() {
		...
		// AJAX 요청
		$.ajax({
			url: `/api/group/detail/board/comment`,  // 서버 URL
			type: "POST",
			data: {
	...
	$(document).on('click', '#reComment', function() {
		...
		// AJAX 요청
		$.ajax({
			url: `/api/group/detail/board/comment`,
			type: "PATCH",
			data: {
				commentId: commentId,
	...
	$(document).on('click', '#replyBtn', function() {
		...
		$.ajax({
			url: `/api/group/detail/board/reply`,
			type: "POST",
			data: {
				commentId: commentId,
...
function loadComments() {
	...
	// @RequestParam Integer boardId 게시판 아이디 가져오기

	let boardId = $('#boardId').val(); // groupId 값 가져오기

	// AJAX 요청으로 모든 댓글 가져오기
	$.ajax({
		url: `/api/group/detail/board/comment`,  // 서버 URL (GET 요청)
		type: "GET",
		data: {
			boardId: boardId
		},
...
function setData(commentData) {
	...
	return `
        <div class="card overflow-hidden rounded-4 border-0 mt-2" data-comment-id="${commentData.commentId}" id="commentList">
            <div class="container mt-4 pb-4">
                <div class="d-flex align-items-center justify-content-between mb-2">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-2">
                            <strong class="nickname">${commentData.author}</strong><br>
                ...
                <div class="comment-content" id="commentContent-${commentData.commentId}">
		...
		return `
                                ...
                                <div class="ms-2 me-2  ps-2 pe-2 pt-2 pb-3"  id="relpyContent-${reply.replyId}">
                                <p class="reply-text" >
                                    ${reply.content}
                             </p>
